 ...
 * {@link Gencsim.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Gencsim#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Gencsim extends Fragment {
     ...
     * @return A new instance of fragment Gencsim.
     */
    // TODO: Rename and change types and number of parameters
    public static Gencsim newInstance(String param1, String param2) {
        Gencsim fragment = new Gencsim();
...
//Add your data to bundle
                ...
                b.putString("messageTittle",tittleMessage.getText().toString());
                intent.putExtras(b);
                startActivity(intent);*/
                USSDcodes ussdCode = new USSDcodes();
                Intent intentA = ussdCode.sendUssdCode(getString(R.string.gencsimTarrif),getString(R.string.azercelimTarifQiymeti),getString(R.string.simpleTarrif),getString(R.string.azn),context);
