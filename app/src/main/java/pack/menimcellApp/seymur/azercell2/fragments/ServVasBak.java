 ...
 * {@link ServVasBak.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ServVasBak#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ServVasBak extends Fragment implements View.OnClickListener {
     ...
     * @return A new instance of fragment ServVasBak.
     */
    // TODO: Rename and change types and number of parameters
    public static ServVasBak newInstance(String param1, String param2) {
        ServVasBak fragment = new ServVasBak();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_serv_vas_bak, container, false);
        context = getContext();
        //recieve balance
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                switch (motionEvent.getAction()) {
                    case MotionEvent.ACTION_DOWN: {
                        btnService1.setBackgroundResource(R.drawable.shadow_bakcell_services);
                        btnService1.setPadding(0,65,0,25);
                        break;
                    }
                    case MotionEvent.ACTION_UP: {
                        btnService1.setBackgroundResource(R.drawable.shadow_opacity_bakcell_services);
                        btnService1.setPadding(0,65,0,25);
                        break;
                    }
                }
        ...
        btnService2.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                switch (motionEvent.getAction()) {
                    case MotionEvent.ACTION_DOWN: {
                        btnService2.setBackgroundResource(R.drawable.shadow_bakcell_services);
                        btnService2.setPadding(0,65,0,25);
                        break;
                    }
                    case MotionEvent.ACTION_UP: {
                        btnService2.setBackgroundResource(R.drawable.shadow_opacity_bakcell_services);
                        btnService2.setPadding(0,65,0,25);
                        break;
                    }
                }
        ...
        btnService3.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                switch (motionEvent.getAction()) {
                    case MotionEvent.ACTION_DOWN: {
                        btnService3.setBackgroundResource(R.drawable.shadow_bakcell_services);
                        btnService3.setPadding(0,65,0,25);
                        break;
                    }
                    case MotionEvent.ACTION_UP: {
                        btnService3.setBackgroundResource(R.drawable.shadow_opacity_bakcell_services);
                        btnService3.setPadding(0,65,0,25);
                        break;
                    }
                }
        ...
        btnService4.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                switch (motionEvent.getAction()) {
                    case MotionEvent.ACTION_DOWN: {
                        btnService4.setBackgroundResource(R.drawable.shadow_bakcell_services);
                        btnService4.setPadding(0,65,0,25);
                        break;
                    }
                    case MotionEvent.ACTION_UP: {
                        btnService4.setBackgroundResource(R.drawable.shadow_opacity_bakcell_services);
                        btnService4.setPadding(0,65,0,25);
                        break;
                    }
                }
        ...
        btnService5.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                switch (motionEvent.getAction()) {
                    case MotionEvent.ACTION_DOWN: {
                        btnService5.setBackgroundResource(R.drawable.shadow_bakcell_services);
                        btnService5.setPadding(0,65,0,25);
                        break;
                    }
                    case MotionEvent.ACTION_UP: {
                        btnService5.setBackgroundResource(R.drawable.shadow_opacity_bakcell_services);
                        btnService5.setPadding(0,65,0,25);
                        break;
                    }
                }
        ...
        btnService6.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                switch (motionEvent.getAction()) {
                    case MotionEvent.ACTION_DOWN: {
                        btnService6.setBackgroundResource(R.drawable.shadow_bakcell_services);
                        btnService6.setPadding(0,65,0,25);
                        break;
                    }
                    case MotionEvent.ACTION_UP: {
                        btnService6.setBackgroundResource(R.drawable.shadow_opacity_bakcell_services);
                        btnService6.setPadding(0,65,0,25);
                        break;
                    }
                }
        ...
        btnService7.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                switch (motionEvent.getAction()) {
                    case MotionEvent.ACTION_DOWN: {
                        btnService7.setBackgroundResource(R.drawable.shadow_bakcell_services);
                        btnService7.setPadding(0,65,0,25);
                        break;
                    }
                    case MotionEvent.ACTION_UP: {
                        btnService7.setBackgroundResource(R.drawable.shadow_opacity_bakcell_services);
                        btnService7.setPadding(0,65,0,25);
                        break;
                    }
                }
        ...
        btnService8.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                switch (motionEvent.getAction()) {
                    case MotionEvent.ACTION_DOWN: {
                        btnService8.setBackgroundResource(R.drawable.shadow_bakcell_services);
                        btnService8.setPadding(0,65,0,25);
                        break;
                    }
                    case MotionEvent.ACTION_UP: {
                        btnService8.setBackgroundResource(R.drawable.shadow_opacity_bakcell_services);
                        btnService8.setPadding(0,65,0,25);
                        break;
                    }
                }
        ...
        btnService9.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                switch (motionEvent.getAction()) {
                    case MotionEvent.ACTION_DOWN: {
                        btnService9.setBackgroundResource(R.drawable.shadow_bakcell_services);
                        btnService9.setPadding(0,65,0,25);
                        break;
                    }
                    case MotionEvent.ACTION_UP: {
                        btnService9.setBackgroundResource(R.drawable.shadow_opacity_bakcell_services);
                        btnService9.setPadding(0,65,0,25);
                        break;
                    }
                }
        ...
        btnService10.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                switch (motionEvent.getAction()) {
                    case MotionEvent.ACTION_DOWN: {
                        btnService10.setBackgroundResource(R.drawable.shadow_bakcell_services);
                        btnService10.setPadding(0,65,0,25);

                        break;
                    }
                    case MotionEvent.ACTION_UP: {
                        btnService10.setBackgroundResource(R.drawable.shadow_opacity_bakcell_services);
                        btnService10.setPadding(0,65,0,25);
                        break;
                    }
                }
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.buttonok) {
            ...
            Intent intentA = ussdCode.sendUssdCode(getString(R.string.balanceUSSDcodeB),getString(R.string.theBalanceWillSend),context);
            startActivity(intentA);

        }
        else if(view.getId() == R.id.btnService2) {
            Intent i = new Intent(Intent.ACTION_VIEW);
            i.setData(Uri.parse("https://bakcell.3dsecure.az/"));
            if(getActivity() != null)
